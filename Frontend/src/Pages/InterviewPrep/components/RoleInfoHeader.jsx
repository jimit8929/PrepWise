...
{/* Mobile view (top & bottom) */}
{/* Mobile view (top & bottom blobs) */}
{/* Mobile-only optimized blobs (top & bottom) */}
<div className="block md:hidden pointer-events-none" aria-hidden="true">
  {/* Top blobs - spread left & right with different sizes/blur for depth */}
  ...
  {/* Bottom blobs - slightly different sizing/blur so they don't mirror exactly */}
