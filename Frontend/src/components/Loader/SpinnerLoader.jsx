...
const SpinnerLoader = () => {
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className="inline w-6 h-6 text-gray-200 animate-spin dark:text-black fill-white"
        viewBox="0 0 100 101"
      ...
      >
        ...
        <path
          ...
          20.348C85.8452 15.1192 80.8826 10.7235 
          75.2124 7.41289C69.5422 4.10237 63.2754 
